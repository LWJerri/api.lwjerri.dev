...
fastify.get("/data", async (req: FastifyRequest, res: FastifyReply) => {
  return await res.status(200).send({
    ...
    projects: [
      ...
      { name: "PorychBot", description: "", stack: [""], emoji: "" },
      { name: "SimonBot", description: "", stack: [""], emoji: "" },
      {
        name: "MyStorage",
        description: "",
        stack: [""],
      ...
      { name: "GTAV", description: "", stack: [""], emoji: "" },
      {
        name: "Riddea",
        description: "",
        stack: [""],
      ...
      { name: "Lequille", description: "", stack: [""], emoji: "" },
      { name: "Modestal", description: "", stack: [""], emoji: "" },
      { name: "LWJENNI", description: "", stack: [""], emoji: "" },
      { name: "AllStarz", description: "", stack: [""], emoji: "" },
      { name: "LoonaSoftBot", description: "", stack: [""], emoji: "" },
      { name: "SelfUser", description: "", stack: [""], emoji: "" },
      {
        name: "lwjerri.dev",
        description: "",
        stack: [""],
      ...
      { name: "ManageGift Web [Old]", description: "", stack: [""], emoji: "" },
      { name: "VilStats", description: "", stack: [""], emoji: "" },
      { name: "Openner", description: "", stack: [""], emoji: "" },
      {
        name: "telegraf-rate-limiter",
        description: "An easy member message rate limiter for the telegraf.js framework.",
        stack: ["npm", "telegraf.js", "npmjs.org"],
        emoji: "📦",
